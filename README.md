...
Para el diseño de los prototipos de la interfaz de usuario de la App Mobile, se aplicaron criterios fundamentales orientados a la experiencia en dispositivos móviles:

1. Claridad y Simplicidad: Se priorizó una navegación fluida e intuitiva, adaptada a pantallas táctiles, de modo que los usuarios pudieran comprender fácilmente funciones clave como el registro de procesos y la consulta de informes estadísticos.

2. Optimización para Dispositivos Móviles: El diseño se centró en aprovechar al máximo el espacio disponible en pantallas pequeñas, asegurando que todos los elementos fueran accesibles y funcionales en distintos modelos de smartphones.

3. Enfoque en la Información Clave: Se diseñó la interfaz para mostrar solo la información más relevante para el usuario objetivo, evitando elementos innecesarios que pudieran dificultar la interacción o saturar visualmente la pantalla.
